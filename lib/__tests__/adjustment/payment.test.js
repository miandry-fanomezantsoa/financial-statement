...
test("Error when Stripe payment's charge not found in Stripe", () => {
    return expect(stripe_api.getCharge('ch_3K1GFVLqBZMTwzGL15ihPOwgqjdkqfs')).rejects.toThrow('This charge ch_3K1GFVLqBZMTwzGL15ihPOwgqjdkqfs not exists in Stripe')
})
